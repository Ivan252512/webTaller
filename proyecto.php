    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-md-18">
          ...
          Queremos aumentar la resiliencia de la población de la Ciudad de México y disminuir el riesgo ante amenazas
          geológicas mediante la comunicación efectiva del conocimiento científico.     
          </p>
...
los conceptos se tocan, se crean y se deconstruyen
          ...
          Tecnologías de la Información y Comunicación (TIC) han permitido una democratización de la información
          sin precedentes en la historia de la humanidad, es por eso que las usamos, tan solo en México según el
          <a href="http://www.beta.inegi.org.mx/contenidos/saladeprensa/boletines/2018/OtrTemEcon/ENDUTIH2018_02.pdf">INEGI</a>
          , 71.3 millones de habitantes tienen acceso a internet en el 2018, eso es más de la mitad de la población.
          </p>

          <hr>

          <h3 align="center" class="section-heading">Sujeto pasivo -> Sujeto activo </h3>

          <hr>
            <center>
            <img class="img-fluid" src="img/proyecto.jpeg" alt="" height="750" width="1100">
            </center>
